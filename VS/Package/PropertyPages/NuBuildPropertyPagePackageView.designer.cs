namespace NuBuild.VS
{
   partial class NuBuildPropertyPagePackageView
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.chkLimitMajorVersionOfDependencies = new System.Windows.Forms.CheckBox();
         this.chkAddExecutablesToLibFolder = new System.Windows.Forms.CheckBox();
         this.chkAutoGenerateDependencies = new System.Windows.Forms.CheckBox();
         ...
         this.lVersionSource.TabIndex = 0;
         ...
         this.chkAddBinariesToSubfolder.Size = new System.Drawing.Size(162, 17);
         this.chkAddBinariesToSubfolder.TabIndex = 2;
         this.chkAddBinariesToSubfolder.Text = "Framework specific package";
         this.toolTip.SetToolTip(this.chkAddBinariesToSubfolder, "Add referenced binaries to subfolders by framework, and if enabled below add fram" +
        "eworkAssemblies and dependencies to metadata by framework");
         ...
         // gbGeneral
         // 
         this.gbGeneral.Controls.Add(this.chkLimitMajorVersionOfDependencies);
         this.gbGeneral.Controls.Add(this.chkAddExecutablesToLibFolder);
         this.gbGeneral.Controls.Add(this.chkAutoGenerateDependencies);
         this.gbGeneral.Location = new System.Drawing.Point(3, 159);
         this.gbGeneral.Name = "gbGeneral";
         this.gbGeneral.Size = new System.Drawing.Size(345, 91);
         this.gbGeneral.TabIndex = 2;
         this.gbGeneral.TabStop = false;
         this.gbGeneral.Text = "General";
         // 
         // chkLimitMajorVersionOfDependencies
         // 
         this.chkLimitMajorVersionOfDependencies.AutoSize = true;
         this.chkLimitMajorVersionOfDependencies.Location = new System.Drawing.Point(27, 42);
         this.chkLimitMajorVersionOfDependencies.Name = "chkLimitMajorVersionOfDependencies";
         this.chkLimitMajorVersionOfDependencies.Size = new System.Drawing.Size(194, 17);
         this.chkLimitMajorVersionOfDependencies.TabIndex = 1;
         this.chkLimitMajorVersionOfDependencies.Text = "Limit major version of dependencies";
         this.chkLimitMajorVersionOfDependencies.UseVisualStyleBackColor = true;
         // 
         // chkAddExecutablesToLibFolder
         // 
         this.chkAddExecutablesToLibFolder.AutoSize = true;
         this.chkAddExecutablesToLibFolder.Location = new System.Drawing.Point(9, 65);
         this.chkAddExecutablesToLibFolder.Name = "chkAddExecutablesToLibFolder";
         this.chkAddExecutablesToLibFolder.Size = new System.Drawing.Size(243, 17);
         this.chkAddExecutablesToLibFolder.TabIndex = 2;
         this.chkAddExecutablesToLibFolder.Text = "Add executables to \\lib instead of \\tools folder";
         this.chkAddExecutablesToLibFolder.UseVisualStyleBackColor = true;
         // 
         // chkAutoGenerateDependencies
         // 
         this.chkAutoGenerateDependencies.AutoSize = true;
         this.chkAutoGenerateDependencies.Location = new System.Drawing.Point(9, 19);
         this.chkAutoGenerateDependencies.Name = "chkAutoGenerateDependencies";
         this.chkAutoGenerateDependencies.Size = new System.Drawing.Size(299, 17);
         this.chkAutoGenerateDependencies.TabIndex = 0;
         this.chkAutoGenerateDependencies.Text = "Add frameworkAssemblies and dependencies to metadata";
         this.chkAutoGenerateDependencies.UseVisualStyleBackColor = true;
         // 
         // toolTip
         // 
      ...
      private System.Windows.Forms.CheckBox chkAutoGenerateDependencies;
      private System.Windows.Forms.ToolTip toolTip;
      private System.Windows.Forms.CheckBox chkAddExecutablesToLibFolder;
      private System.Windows.Forms.CheckBox chkLimitMajorVersionOfDependencies;
   }
}