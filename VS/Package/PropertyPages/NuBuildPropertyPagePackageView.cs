...
namespace NuBuild.VS
{
   ...
   {
      [Description("Silverlight,v4.0,WindowsPhone70|Silverlight 4 (WP 7.0)")]
      SL40WP70,
      [Description("Silverlight,v4.0,WindowsPhone71|Silverlight 4 (WP 7.1)")]
      SL40WP71,
      [Description(".NETFramework,v4.0,|.NET Framework 4")]
      Net40,
      [Description(".NETFramework,v4.5,|.NET Framework 4.5")]
      Net45,
      [Description(".NETFramework,v4.5.1,|.NET Framework 4.5.1")]
      Net451,
      [Description(".NETFramework,v4.5.2,|.NET Framework 4.5.2")]
      Net452,
   }
   ...
   partial class NuBuildPropertyPagePackageView : PageView
   {
      ...
      public const string TargetFrameworkPropertyTag = "TargetFrameworkIdentifier,TargetFrameworkVersion,TargetFrameworkProfile";
      ...
      public const string LimitMajorVersionOfDependenciesPropertyTag = "NuBuildLimitMajorVersionOfDependencies";
      public const string AddExecutablesToLibFolderPropertyTag = "NuBuildAddExecutablesToLibFolder";
      ...
      protected override PropertyControlTable PropertyControlTable
      {
         get
         {
            if (propertyControlTable == null)
            {
               ...
               propertyControlTable.Add(TargetFrameworkPropertyTag, cbTargetFramework, new EnumDescriptionTypeConverter<TargetFramework>());
               ...
               propertyControlTable.Add(LimitMajorVersionOfDependenciesPropertyTag, chkLimitMajorVersionOfDependencies);
               propertyControlTable.Add(AddExecutablesToLibFolderPropertyTag, chkAddExecutablesToLibFolder);
            }
