...
{
   [Guid("3FDA0BDD-B3D2-486F-AF86-B28F355BFACC")]
   class NuBuildPropertyPagePackage : PropertyPage
   {
      ...
      /// </summary>
      /// <returns></returns>
      protected override IPageView GetNewPageView() => new NuBuildPropertyPagePackageView(this);
